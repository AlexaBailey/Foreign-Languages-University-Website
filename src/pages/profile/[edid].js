                ...
                {details&& details.map((detail)=>{
                  return(
                    ...
                    <form className='profile-right' onSubmit={formik.handleSubmit}>
                       ...
                       <input placeholder={detail.username}  name='username'  className='edit-input'  onChange={formik.handleChange} onBlur={formik.handleBlur}
...
{formik.errors.username ? <p className="error" >
               ...
               <input placeholder={detail.email} name='email' className='edit-input' onChange={formik.handleChange}
...
{formik.errors.email ? <p className="error" >
              ...
              <input placeholder={detail.desc}  name='bio' className='edit-input'  onChange={formik.handleChange} 
       value={formik.values.bio}/>
              <button style={{marginTop:30}} className='start-button save' onSubmit={formik.handleSubmit}>Отправить</button>
                    ...
                    <div>
                       ...
                       <input name='fio' placeholder={detail.fio}  className='edit-input' onChange={formik.handleChange} onBlur={formik.handleBlur}
